...
class BasPur(models.Model):
    ...
    see_num = models.IntegerField(db_column='SEE_NUM', blank=True, null=True)  # Field name made lowercase.
...
class Kggoodsret(models.Model):
    ...
    saletype = models.CharField(db_column='SaleType', max_length=10, blank=True, null=True)
